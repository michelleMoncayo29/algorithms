...
class Reader {
    ...
    returnBook(isbn) {
        ...
        if (index === -1) {
            throw new Error('This book is not borrowed by the reader');
        }
...
class DigitalLibrary {
    ...
    getMostBorrowedBook() {
        ...
        return this.books.reduce((maxBook, currentBook) => {
            if (currentBook.getBorrowCount() > maxBook.getBorrowCount()) {
                return currentBook; 
            } else {
                return maxBook; 
            }
